...
<head>
    ...
    <meta name="keywords" content="shuttle, travel, booking tiket, pelacakan gps, d-voyager, tiket travel, duitku">
...
<body class="bg-[#F8F9FA] text-dark-900 font-sans antialiased overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                ...
                <div class="text-center p-6 relative group">
                    ...
                    <p class="text-dark-500 text-sm leading-relaxed">
                        Lakukan pembayaran aman didukung oleh integrasi resmi Payment Gateway DuitKu.
                    </p>
                </div>
    ...
    <section class="py-16 bg-[#F8F9FA] border-y border-slate-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span class="block text-xs font-bold text-dark-400 uppercase tracking-widest mb-6">Metode Pembayaran Resmi Terintegrasi (DuitKu)</span>
            ...
            <div class="flex flex-wrap items-center justify-center gap-8 sm:gap-12 md:gap-16 opacity-75 hover:opacity-100 transition-all duration-300">
                <!-- DuitKu logo representation in #1E1E1E with golden yellow dot -->
                <div class="flex items-center gap-1 font-outfit font-extrabold text-xl tracking-wider text-dark-900">
                    DUIT<span class="text-brand-500 font-extrabold">KU</span>
                </div>
            ...
            <div class="mt-6 text-dark-500 text-xs">
                Transaksi Anda dilindungi dengan enkripsi SSL 256-bit dan mematuhi regulasi keamanan PCI-DSS melalui DuitKu Payment Gateway.
            </div>
        </div>
    </section>
    ...
    <footer class="bg-dark-900 text-slate-300 py-16 border-t border-dark-800 font-sans">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-12 border-b border-dark-800">
                ...
                <!-- Legal Compliance (SANGAT VITAL UNTUK DUITKU PG) -->
            ...
            <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-dark-400">
                ...
                <div class="flex items-center gap-4">
                    <span>Didukung oleh: <strong class="text-brand-500">DuitKu PG</strong></span>
    ...
    <script>
        ...
        function checkoutSimulasi() {
            alert(`[SIMULASI PEMBAYARAN DUITKU]\n\nAnda memesan tiket Shuttle ID: ${activeRouteId}\nNomor Kursi: ${selectedSeatNum}\nMetode Pembayaran: DuitKu Payment Gateway\n\nStatus: Simulasi Sukses! Integrasi DuitKu API aktif pada environment produksi.`);
        }

        // 2. Legal Modals Content Data and Display Functions (CRITICAL FOR DUITKU MERCHANT APPROVAL)
        const modalContents = {
            privacy: {
                ...
                body: `
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        ...
                        <li>Data Transaksi: Detail pemesanan tiket, riwayat transaksi pembayaran melalui payment gateway DuitKu, dan detail rute perjalanan Anda.</li>
                    ...
                    <ul class="list-disc pl-5 space-y-1">
                        ...
                        <li>Memverifikasi transaksi pembayaran aman yang diproses melalui mitra resmi kami, DuitKu.</li>
                    ...
                    <p>Kami tidak menjual, memperdagangkan, atau memindahkan informasi pribadi Anda kepada pihak luar secara ilegal. Informasi transaksi keuangan Anda akan diteruskan secara aman ke **DuitKu Payment Gateway** selaku mitra resmi kami yang berlisensi dari Bank Indonesia guna memproses pembayaran secara legal.</p>

                    <h4 class="font-bold text-slate-800 text-sm uppercase mt-4">5. Keamanan Data Pengguna</h4>
                    <p>Kami menerapkan berbagai langkah keamanan teknis, termasuk enkripsi data SSL (Secure Socket Layer) 256-bit, untuk menjaga kerahasiaan informasi pribadi Anda dari akses yang tidak sah. Data kartu kredit atau detail pembayaran sensitif diproses langsung pada server DuitKu yang memenuhi sertifikasi keamanan internasional PCI-DSS.</p>
                `
            },
            terms: {
                ...
                body: `
                    ...
                    <p>Seluruh transaksi tiket di D-Voyager wajib diselesaikan secara lunas menggunakan metode pembayaran resmi yang tersedia di portal checkout. Pembayaran digital diproses secara instan melalui sistem terintegrasi **DuitKu Payment Gateway**.</p>
