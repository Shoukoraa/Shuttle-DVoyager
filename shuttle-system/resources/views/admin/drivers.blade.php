        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm h-fit">
            ...
            <form action="/admin/drivers" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="relative">
                        <input type="password" name="password" id="password" placeholder="Minimal 6 karakter" required minlength="6" class="w-full bg-gray-50 border border-gray-200 text-dark-900 text-sm rounded-xl pl-4 pr-11 py-2.5 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all font-medium">
